/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5d7b754da499a975526115a2552c37c9)
// Runtime types generated with workerd@1.20260426.1 2026-04-29 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DisasterCoordination";
	}
	interface Env {
		DATABASE_URL: string;
		...
		FRONTEND_URL: string;
		DISASTER_COORDINATION: DurableObjectNamespace<import("./src/index").DisasterCoordination>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "FRONTEND_URL">> {}
}
